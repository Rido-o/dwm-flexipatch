...
const char *spcmd1[] = {"st", "-n", "spterm", "-g", "120x50", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_w,          spawn,                  SHCMD("$TERMINAL -n floatcenter -g 120x50 nvim -c ':VimwikiIndex'") },
	{ MODKEY,                       XK_n,          spawn,                  SHCMD("$TERMINAL -n floatcenter -g 120x50 nnn -e -D") },
